  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name='email']")).SendKeys("vlavanya10@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@name='password']")).SendKeys("lavanya");
            Thread.Sleep(1000);
